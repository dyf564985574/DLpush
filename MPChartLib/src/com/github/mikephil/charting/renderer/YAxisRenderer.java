...
//            String text = mYAxis.getFormattedLabel(i);
            index = (positions[1] - positions[3])/20;
            String text = mYAxis.getFormattedLabel(i)+"%";
            Log.i("fixedPosition", text + "      " + positions[i * 2 +1] + offset);
            if("110.0%".equals(text)){

                c.drawText(text, fixedPosition, positions[i * 2 +1] + offset, mAxisLabelPaint);
            }else if ("120.0%".equals(text)){
                c.drawText("", fixedPosition, positions[i * 2 +1] + offset, mAxisLabelPaint);
            }
             else{
                text = (Float.parseFloat(mYAxis.getFormattedLabel(i)) + 5 * i) + "%";
                ...
                c.drawText(text, fixedPosition, positions[i * 2 + 1] + offset - index * 5 * i, mAxisLabelPaint);
            }
//            c.drawText(text, fixedPosition, positions[i * 2 +1] + offset, mAxisLabelPaint);
        }
    }
