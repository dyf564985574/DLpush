...
public class DonutProgress extends View {
    ...
    private int innerBackgroundCircle_color;
    ...
    protected void initPainters() {
        ...
        finishedPaint.setStrokeWidth(unfinishedStrokeWidth);
//        finishedPaint.setStrokeWidth(finishedStrokeWidth);
        ...
        borderPaint.setColor(innerBackgroundCircle_color);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        innerBackgroundCircle_color = attributes.getColor(R.styleable.DonutProgress_donut_background_circle_color, default_inner_background_color);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.i("innerCircleRadius",innerCircleRadius+"");
        canvas.drawCircle(getWidth() / 2.0f, getHeight() / 2.0f, innerCircleRadius-1, innerCirclePaint);
        canvas.drawCircle(getWidth() / 2.0f, getHeight() / 2.0f, innerCircleRadius+1, borderPaint);
