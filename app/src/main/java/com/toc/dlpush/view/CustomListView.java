...
public class CustomListView extends ListView implements OnScrollListener {
    ...
    /**当数据不足十条时 不显示更多和没有更多**/
    private final static int ENDINT_NO_TEN = 4;
...
//			mLastUpdatedTextView.setVisibility(View.VISIBLE);
	 ...
	 */
	public void onRefresh() {
        Log.i("onRefresh ",(mRefreshListener != null)+"");
    ...
    public void AutoRefresh(){
        mHeadState = REFRESHING;
        UtilTool.translateAnimations(mHeadView,true);
        changeHeaderViewByState();
    }
	 ...
	 * @version 1.0
	 */
	public void onLoadMoreComplete(boolean aa,String bb) {
		if(aa){
			mEndState = ENDINT_AUTO_LOAD_DONE;
		}else{
			mEndState = ENDINT_MANUAL_LOAD_DONE;
